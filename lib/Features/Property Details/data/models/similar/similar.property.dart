import 'category.property.dart';
import 'image.property.dart';
...
class SimilarModel {
  ...
  dynamic distanceKm;
  dynamic distance;
  CategorySimilarModel? category;
  List<ImageSimilarModel>? images;
  dynamic agent;
  ...
  factory SimilarModel.fromJson(Map<String, dynamic> json) {
    return SimilarModel(
      ...
      category: json['category'] == null
          ? null
          : CategorySimilarModel.fromJson(
              json['category'] as Map<String, dynamic>,
            ),
      images: (json['images'] as List<dynamic>?)
          ?.map((e) => ImageSimilarModel.fromJson(e as Map<String, dynamic>))
          .toList(),
