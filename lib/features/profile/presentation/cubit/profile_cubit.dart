...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  Future<void> updateProfile({
    ...
    final result = await profileRepository.updateProfile(name: name, location: location, phone: phone);
  ...
  Future<void> changePassword({
    ...
    final result = await profileRepository.changePassword(currentPassword: currentPassword,
